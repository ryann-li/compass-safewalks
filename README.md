...
export DATABASE_URL="postgresql+psycopg2://safewalks:safewalks@localhost:5432/safewalks" && export JWT_SECRET="dev-secret-key" && export TOWER_SHARED_KEY="dev-tower-key" && export JWT_EXP_SECONDS="3600" && uvicorn api.index:app --reload --host 0.0.0.0 --port 8000

# Twilio configuration (commented out):
# export TWILIO_ACCOUNT_SID="YOUR_ACCOUNT_SID" && export TWILIO_AUTH_TOKEN="YOUR_AUTH_TOKEN" && export TWILIO_FROM_NUMBER="YOUR_FROM_NUMBER" && export SOS_ALERT_NUMBERS="YOUR_ALERT_NUMBERS"